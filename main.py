...
PLAYER_NAME = input("Enter your online name: ")
...
class Camera:
    ...
    def update(self, car):
        self.x = car.x - SCREEN_WIDTH // 2
        self.y = car.y - SCREEN_HEIGHT // 2
...
def main():
    ...
    # Create font for speed display
    font = pygame.font.Font(None, 36)
    
    # Create car at world position (0, 0)
    car = Car(0, 0, [120, 0, 240])
    ...
    while running:
        ...
        end_x = start_x + SCREEN_WIDTH + 200
        ...
        for i in range(start_x, end_x, 100):
            ...
            if -50 <= line_start_x <= SCREEN_WIDTH + 50:
        ...
        end_y = start_y + SCREEN_HEIGHT + 200
        ...
        for i in range(start_y, end_y, 100):
            ...
            # Only draw if visible on screen
            if -50 <= line_start_y <= SCREEN_HEIGHT + 50:
                pygame.draw.line(screen, GRAY, (line_start_x, line_start_y), (line_end_x, line_end_y), 5)
